...
public class ItemRegistry {
    ...
    public static final DeferredItem<BlockItem> STACKED_PALE_OAK_PLANKS_ITEM = ITEMS.registerSimpleBlockItem("stacked_pale_oak_planks", BlockRegistry.STACKED_PALE_OAK_PLANKS);
